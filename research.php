  ...
  <div class="shell section" id="presentations">
    ...
    <div class="grid grid--auto mt-5">
      ...
      <article class="card">
        ...
        <h3 class="mt-2"><a href="https://cdercenter.org/sigcse/">SIGCSE</a></h3>
...
<div class="shell section" id="methodology">
  ...
  <div class="grid grid--auto mt-5">
    <article class="card"><h3>Baseline first</h3><p>For both CS1 and CS2, data was obtained for a baseline
    ...
    <article class="card"><h3>Shared instruments</h3><p>Common pre- and post-course surveys captured student
    ...
    <article class="card"><h3>Activity-level assessment</h3><p>Individual activities added pre/post quizzes
    ...
    <article class="card"><h3>Paired statistics</h3><p>Matched pre/post responses analyzed with
    ...
    <article class="card"><h3>Qualitative coding</h3><p>Thematic analysis of open-response questions
      alongside the quantitative results, so the numbers come with student reasoning attached.</p></article>
    <article class="card"><h3>IRB throughout</h3><p>Each testing team applied for IRB approval and developed
    ...
    <article class="card"><h3>Faculty instruments too</h3><p>Pre-selection, post-selection, annual and
...
<div class="band band--tint">
  <div class="shell section" id="findings">
    ...
    <div class="grid grid--halves mt-4">
      <article class="card"><h3>USI · CS1</h3>
